...
################################################################################
## Form generated from reading UI file 'interfaceUeDKcL.ui'
##
...
import gui_interface_pyqt5_sqlite.QSS_Resources_rc as QSS_Resources_rc

class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        if not MainWindow.objectName():
            MainWindow.setObjectName(u"MainWindow")
        MainWindow.resize(916, 736)
...
"}")
        ...
        self.mainBody.setMinimumSize(QSize(916, 607))
        ...
        self.widget.setMinimumSize(QSize(200, 588))
        ...
        self.showUsuarioBtn = QPushButton(self.frame_6)
        self.showUsuarioBtn.setObjectName(u"showUsuarioBtn")
        font2 = QFont()
        font2.setBold(True)
        font2.setWeight(75)
        self.showUsuarioBtn.setFont(font2)
        self.showUsuarioBtn.setCursor(QCursor(Qt.PointingHandCursor))
        icon10 = QIcon()
        icon10.addFile(u":/icons/Icons/plus-square.png", QSize(), QIcon.Normal, QIcon.Off)
        self.showUsuarioBtn.setIcon(icon10)

        self.horizontalLayout_5.addWidget(self.showUsuarioBtn, 0, Qt.AlignRight)
        ...
        self.label_3.setGeometry(QRect(150, 210, 181, 161))
        ...
        self.label_7.setGeometry(QRect(160, 220, 181, 161))
        ...
        self.label_5.setGeometry(QRect(160, 200, 181, 161))
        ...
        self.label_4.setGeometry(QRect(160, 220, 181, 161))
        self.label_4.setFont(font1)
        self.mainPages.addWidget(self.aboutPage)
        self.accountPage = QWidget()
        self.accountPage.setObjectName(u"accountPage")
        self.label_6 = QLabel(self.accountPage)
        self.label_6.setObjectName(u"label_6")
        self.label_6.setGeometry(QRect(150, 190, 181, 161))
        ...
        self.widget_2.setMinimumSize(QSize(170, 262))
        ...
        self.usuario = QLineEdit(self.frame_5)
        self.usuario.setObjectName(u"usuario")

        self.verticalLayout_9.addWidget(self.usuario)
        ...
        self.telefone = QLineEdit(self.frame_5)
        ...
        self.addUsuarioBtn = QPushButton(self.widget_2)
        self.addUsuarioBtn.setObjectName(u"addUsuarioBtn")
        self.addUsuarioBtn.setFont(font2)
        self.addUsuarioBtn.setCursor(QCursor(Qt.PointingHandCursor))
        icon11 = QIcon()
        icon11.addFile(u":/icons/Icons/file-plus.png", QSize(), QIcon.Normal, QIcon.Off)
        self.addUsuarioBtn.setIcon(icon11)

        self.verticalLayout_8.addWidget(self.addUsuarioBtn, 0, Qt.AlignHCenter)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(QCoreApplication.translate("MainWindow", u"Meu App", None))
        ...
        self.showUsuarioBtn.setText(QCoreApplication.translate("MainWindow", u"Adicionar Usuario", None))
        ...
        self.telefone.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Telefone", None))
        self.addUsuarioBtn.setText(QCoreApplication.translate("MainWindow", u"Novo Usuario", None))
        self.label_9.setText(QCoreApplication.translate("MainWindow", u"Modern UI CopyRigth 2022", None))
    # retranslateUi
